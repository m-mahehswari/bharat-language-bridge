...
const cardVariants = cva(
  "rounded-2xl text-card-foreground transition-all",
  {
    variants: {
      variant: {
        default: "bg-card shadow-[var(--shadow-md)]",
        elevated: "bg-gradient-to-br from-card to-muted/30 shadow-[var(--shadow-lg)]",
        outlined: "bg-transparent border-2 border-border",
        glass: "bg-card/80 backdrop-blur-sm shadow-[var(--shadow-md)]",
      },
    },
    defaultVariants: {
      variant: "default",
